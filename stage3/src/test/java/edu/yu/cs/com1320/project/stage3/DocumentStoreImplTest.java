...
public class DocumentStoreImplTest {
    ...
    public void testPutNewVersionOfDocumentPdf(){
        ...
        //TODO allowing for student following old API comment. To be changed for stage 2 to insist on following new comment.
        assertTrue(returned == 0 || returned == this.pdfTxt1.hashCode());
        byte[] bytes = store.getDocumentAsPdf(this.uri1);
        assertEquals("failed to return correct pdf text",this.pdfTxt1,Utils.pdfDataToText(bytes));
        ...
        //TODO allowing for student following old API comment. To be changed for stage 2 to insist on following new comment.
        int num = this.pdfTxt1.hashCode();
        assertTrue("should return hashcode of old text", num == returned || this.pdfTxt2.hashCode() == returned);
    ...
    public void testDeleteDoc(){
        ...
        byte[] bytes = store.getDocumentAsPdf(this.uri1);
        assertEquals("calling get on URI from which doc was deleted should've returned null", null, bytes);
    }
